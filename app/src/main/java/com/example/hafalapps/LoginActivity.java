...
public class LoginActivity extends AppCompatActivity {
    ...
    private void beginRecovery(String email) {
        ...
        pd.setMessage("Mengirim ke alamat email...");
        pd.show();
        mAuth.sendPasswordResetEmail(email)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            Toast.makeText(LoginActivity.this, "Link pemulihan sudah terkirim ke email anda...", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(LoginActivity.this, "Email tidak tersedia, masukan email lain...", Toast.LENGTH_SHORT).show();
                        }
                    }
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                //get and show proper error messeage
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            //user is logged om, so start LoginActivity
